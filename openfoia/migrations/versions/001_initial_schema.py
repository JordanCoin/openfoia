...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("level", sa.Enum("federal", "state", "local", "tribal", name="agencylevel"), nullable=False),
        ...
        sa.Column("preferred_method", sa.Enum("fax", "mail", "email", "web_portal", "in_person", name="deliverymethod"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("delivery_method", sa.Enum("fax", "mail", "email", "web_portal", "in_person", name="deliverymethod"), nullable=False),
        sa.Column("delivery_reference", sa.String(255), nullable=True),
        sa.Column("status", sa.Enum("draft", "pending_send", "sent", "acknowledged", "processing", "fee_estimate", "fee_paid", "partial_response", "complete", "denied", "appealed", "litigation", "closed", name="requeststatus"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("doc_type", sa.Enum("acknowledgment", "fee_estimate", "partial_response", "full_response", "denial", "glomar", "no_records", "referral", "appeal_response", "correspondence", name="documenttype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("entity_type", sa.Enum("person", "organization", "location", "date", "money", "document_id", "phone", "email", "address", name="entitytype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("confidence", sa.Enum("confirmed", "probable", "possible", "unresolved", name="confidencelevel"), nullable=True),
